...
export const skills = [
  ...
  { name: "Postgre SQL", icon: "logos:postgresql" },
  { name: "Machine Learning", icon: "logos:machine-learning" },
  { name: "Computer Vision", icon: "logos:computer-vision" },
  { name: "Classification & Regression", icon: "logos:data-analysis" },
