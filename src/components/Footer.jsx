...
//   return (
//     <footer className="bg-light dark:bg-dark-light py-8 border-t border-light-darker dark:border-dark-lighter">
...
//             {Object.entries(personalData.socialLinks).map(([platform, link]) => (
//               <a
//                 key={platform}
//                 href={link}
//                 target="_blank"
...
//                 aria-label={platform}
//               >
//                 <Icon icon={`logos:${platform}`} className="w-6 h-6" />
//               </a>
//             ))}
//           </div>
//         </div>
        
//         <div className="mt-8 text-center text-sm text-dark-lighter dark:text-light-darker">
