...
//           <span className="text-primary dark:text-primary-dark">My</span> Experience
//         </h2>
        
//         <div className="space-y-8">
//           {experience.map((exp, index) => (
//             <div key={index} className="bg-light dark:bg-dark-light p-6 rounded-lg shadow-md">
//               <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
//                 <h3 className="text-xl font-bold text-dark dark:text-light">
//                   {exp.role} · {exp.company}
//                 </h3>
//                 <span className="text-primary dark:text-primary-dark">{exp.period}</span>
//               </div>
...
//                     <span className="text-dark-lighter dark:text-light-darker">{item}</span>
//                   </li>
//                 ))}
//               </ul>
