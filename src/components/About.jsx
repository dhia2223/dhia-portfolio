...
// import { personalData, education, associations } from '../constants/data';
...
//           <div>
//             <h3 className="text-2xl font-bold mb-6 text-dark dark:text-light">Who I Am</h3>
//             <p className="text-lg mb-6 text-dark-lighter dark:text-light-darker">
//               {personalData.description}
//             </p>
            
//             <div className="space-y-4">
//               <div className="flex items-start">
//                 <Icon icon="ph:code-bold" className="w-6 h-6 mt-1 mr-4 text-primary dark:text-primary-dark" />
//                 <div>
...
//               <div className="flex items-start">
//                 <Icon icon="ph:stack-bold" className="w-6 h-6 mt-1 mr-4 text-primary dark:text-primary-dark" />
//                 <div>
...
//           <div>
//             <h3 className="text-2xl font-bold mb-6 text-dark dark:text-light">Education</h3>
//             <div className="space-y-6">
//               {education.map((edu, index) => (
//                 <div key={index} className="bg-light dark:bg-dark-light p-6 rounded-lg shadow-sm">
//                   <h4 className="text-lg font-medium text-dark dark:text-light">{edu.degree}</h4>
//                   <p className="text-primary dark:text-primary-dark mb-1">{edu.institution}</p>
//                   <p className="text-dark-lighter dark:text-light-darker">{edu.year}</p>
//                 </div>
//               ))}
//             </div>
            
//             <h3 className="text-2xl font-bold mt-8 mb-6 text-dark dark:text-light">Associations</h3>
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//               {associations.map((assoc, index) => (
//                 <div key={index} className="bg-light dark:bg-dark-light p-4 rounded-lg shadow-sm flex items-center">
