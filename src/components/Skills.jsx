...
//             <div
//               key={index}
//               className="bg-light dark:bg-dark-light p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center"
//             >
//               <Icon icon={skill.icon} className="w-12 h-12 mb-3 text-primary dark:text-primary-dark" />
