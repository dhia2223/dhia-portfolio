...
//       <motion.div 
//         className="absolute -right-20 -top-20 w-64 h-64 rounded-full bg-primary/10 dark:bg-primary-dark/10 blur-3xl"
//         initial={{ scale: 0.8, opacity: 80 }}
...
//           <motion.h2 
//             variants={itemVariants}
//             className="text-2xl md:text-3xl mb-6 text-dark dark:text-light"
//           >
//             {personalData.title}
//           </motion.h2>
...
//           <motion.p 
//             variants={itemVariants}
//             className="text-lg mb-8 text-dark-lighter dark:text-light-darker max-w-lg"
//           >
...
//             <motion.a
//               href="#contact"
//               className="px-6 py-3 bg-primary dark:bg-primary-dark text-white rounded-md hover:bg-primary-dark dark:hover:bg-primary transition-all duration-300 shadow-lg hover:shadow-primary/30 dark:hover:shadow-primary-dark/30"
//               whileHover={{ y: -2 }}
//               whileTap={{ scale: 0.95 }}
//             >
//               Contact Me
...
//             <motion.a
//               href="#projects"
//               className="px-6 py-3 border-2 border-primary dark:border-primary-dark text-primary dark:text-primary-dark rounded-md hover:bg-primary/10 dark:hover:bg-primary-dark/10 transition-all duration-300"
//               whileHover={{ y: -2 }}
//               whileTap={{ scale: 0.95 }}
//             >
//               View Projects
...
//             {/* Decorative elements */}
//             <div className="absolute -left-10 -top-10 w-32 h-32 rounded-full bg-secondary/20 dark:bg-secondary-dark/20 blur-xl z-0" />
//             <div className="absolute -right-10 -bottom-10 w-40 h-40 rounded-full bg-accent/20 dark:bg-accent-dark/20 blur-xl z-0" />
//           </div>
//         </motion.div>
//       </motion.div>
//     </section>
