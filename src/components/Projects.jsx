...
//             <div
//               key={index}
//               className="bg-light dark:bg-dark-light rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow"
//             >
...
//                 <p className="text-dark-lighter dark:text-light-darker mb-4">{project.description}</p>
